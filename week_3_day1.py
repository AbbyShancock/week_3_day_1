...
# 2. name
name = "Abby" #string variable
# 3. song
song = "Party in the USA" #string variable
# 4. food
food = "cookies" #string variable
# 5. number
...
print(name + " liked to hum the song " + song + " while coding. It was so annoying that their classmates would throw " + food + " until " + name + " would stop singing.")
